...
import com.awesomecopilot.boot.oauth2.properties.CopilotOauth2Properties;
...
@EnableConfigurationProperties(CopilotOauth2Properties.class)
@ConditionalOnMissingBean(AuthorizationServerConfigurerAdapter.class)
public class CopilotOauth2AuthorizationServerAutoConfig extends AuthorizationServerConfigurerAdapter {
	
	@Autowired
	private CopilotOauth2Properties copilotOauth2Properties;
	...
	public TokenStore tokenStore() {
		if (copilotOauth2Properties.getJwt().isEnabled()) {
	...
	@Bean
	@ConditionalOnProperty(value = "copilot.oauth2.jwt.enabled", matchIfMissing = false)

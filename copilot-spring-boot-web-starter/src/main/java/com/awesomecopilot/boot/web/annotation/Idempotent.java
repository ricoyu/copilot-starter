package com.awesomecopilot.boot.web.annotation;
...
/**
 * 接口幂等性, 基于token机制实现, 这个@Idempotent注解是用在SpringBoot Web应用上的, SpringCloud应用使用这个annotation: com.awesomecopilot.cloud.feign.annotation.Idempotent
 *
 * <ol>

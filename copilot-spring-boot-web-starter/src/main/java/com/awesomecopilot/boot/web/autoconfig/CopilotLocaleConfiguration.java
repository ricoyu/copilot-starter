...
import com.awesomecopilot.common.spring.filter.LocaleConfigurerFilter;
import com.awesomecopilot.common.spring.interceptor.LocaleChangeInterceptor;
...
@ConditionalOnProperty(prefix = "copilot.locale", name = "enabled", havingValue = "true")
@Slf4j
public class CopilotLocaleConfiguration implements WebMvcConfigurer {

package com.awesomecopilot.boot.security.props;
 ...
 */
@Data
@ConfigurationProperties(prefix = "copilot.security")
public class CopilotSecurityProperties {
	...
	/**
	 * Token是否加密处理过<p>
	 * 客户端将请求的URI, access_token, 客户端当前的timestamp用公钥加密, 将加密后的字符串作为access_token传递过来<p>

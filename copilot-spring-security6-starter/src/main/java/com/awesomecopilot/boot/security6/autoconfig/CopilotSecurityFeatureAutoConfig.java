...
import com.awesomecopilot.security6.advice.RestSecurityExceptionAdvice;
import com.awesomecopilot.security6.controller.VerifyCodeController;
import com.awesomecopilot.security6.handler.RestAccessDeniedHandler;
import com.awesomecopilot.security6.intercepter.TokenBasedAntiDupSubmitIntercepter;
import com.awesomecopilot.security6.listener.AuthenticationFailureListener;
...
public class CopilotSecurityFeatureAutoConfig implements WebMvcConfigurer {
	 ...
	 */
	@Bean
	@ConditionalOnProperty(prefix = "copilot.security6.feature.pic-code", name = "enabled", havingValue = "true", matchIfMissing = false)

...
import com.awesomecopilot.security.expression.handler.WildcardMethodSecurityExpressionHandler;
import com.awesomecopilot.security.filter.PreAuthenticationFilter;
...
import com.awesomecopilot.security.filter.VerifyCodeFilter;
import com.awesomecopilot.security.filter.XSSFilter;
import com.awesomecopilot.security.handler.LoginFailureHandler;
import com.awesomecopilot.security.handler.LoginSuccessHandler;
import com.awesomecopilot.security.handler.LogoutSuccessHandler;
import com.awesomecopilot.security.properties.CopilotSecurityProperties;
import com.awesomecopilot.security.service.PreAuthenticationUserDetailsService;
...
public class CopilotWebSecurityAutoConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(HttpSecurity http)  throws Exception {
		...
		http.authorizeRequests()
				.antMatchers(anonymousUrls()).permitAll()  // 使用 antMatchers 替代 requestMatchers
		...
		http.addFilterBefore(preAuthenticationFilter(authenticationManager),
						UsernamePasswordAuthenticationFilter.class);
		http.addFilterAt(usernamePasswordAuthenticationFilter(authenticationManager),
	...
	@Bean
	@ConditionalOnProperty(prefix = "copilot.security", name = "user-pass-login.enabled", havingValue = "true", matchIfMissing = false)
	...
	@Bean
	@ConditionalOnProperty(prefix = "copilot.security.feature.pic-code", name = "enabled", havingValue = "true", matchIfMissing
			= false)
